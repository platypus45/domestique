...
- **Easing a hard day no longer secretly made it harder.** Stepping a session down a tier could hand you *more* work than the original — on the live plan that affected 28 of 45 hard sessions. Every path that eases a session now holds the load, in the plan, in the response and in the workout file attached to the day, which previously could all disagree.
